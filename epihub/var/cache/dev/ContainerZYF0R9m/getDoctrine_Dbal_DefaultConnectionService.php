...
return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'host' => '127.0.0.1', 'port' => 8889, 'user' => $this->getEnv('DATABASE_USER'), 'password' => $this->getEnv('DATABASE_PWD'), 'dbname' => $this->getEnv('DATABASE_NAME'), 'url' => $this->getEnv('resolve:DATABASE_URL'), 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => ['charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci']], $a, $d, []);
