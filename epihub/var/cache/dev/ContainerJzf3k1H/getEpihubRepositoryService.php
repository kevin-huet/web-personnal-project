...
// Returns the private 'App\Repository\EpihubRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EpihubRepository.php';

return $this->privates['App\Repository\EpihubRepository'] = new \App\Repository\EpihubRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
